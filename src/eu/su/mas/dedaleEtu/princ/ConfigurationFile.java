...
public final class ConfigurationFile {
	...
	public static String LOCAL_CONTAINER5_NAME=PLATFORM_ID+"_"+"container5";
	 ...
	 */
	public static String INSTANCE_TOPOLOGY="resources/mymap-topology";
	//public static String INSTANCE_TOPOLOGY=null;
	
	/**
	 * Not null when the environment is loaded; should be null if the environment is generated or already online
	 */
	public static String INSTANCE_CONFIGURATION_ELEMENTS="resources/mymap-elements";
	 ...
	 */
	public static String INSTANCE_CONFIGURATION_ENTITIES="resources/mymap-entities";
	//public static String INSTANCE_CONFIGURATION_ENTITIES="resources/monAgent-entities";
